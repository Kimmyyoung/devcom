...
const JobCard = ({ data }: JobCardProps) => {
  ...
  return (
    ...
    <div className="flex flex-row gap-10 font-pretendardRegular rounded-lg bg-gray-100 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:bg-gray-300 cursor-pointer">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          <p className="text-blue-950 text-xs">{employer_name}</p>
          <IconContext.Provider value={{ color: "#172554", className: "react-icons", size: "1em" }}>    
            <FaLocationDot />  
          </IconContext.Provider>
              <p className="text-blue-950 text-xs">{job_country}</p>
        </div>
      </div>
